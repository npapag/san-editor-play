package trees
{
	...
	public class EntityTreeItemRenderer extends TreeItemRenderer
	{
			...
			if (super.data!=null) {
				...
				if (super.icon != null) {
					...
					switch (itemXML.localName()) {
						case "global":
							super.label.text = "Global";
							break;
						case "sans":
							super.label.text = "Sans";
							break;
						case "context":
							super.label.text = "Context";
							break;
						case "entity":
							super.label.text = itemXML.@name;
							break;
						case "apools":
							super.label.text = "Action Pools";
							break;
						case "apool":
							super.label.text = itemXML.@name;
							break;
